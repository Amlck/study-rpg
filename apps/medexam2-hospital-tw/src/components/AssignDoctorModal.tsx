...
import { getDoctorEquipmentBonus } from '../services/doctor-equipment'

interface AssignDoctorModalProps {
  room: Room
  currentDoctor: DoctorRow | null
  /** Doctor equipment currently equipped by each doctor, keyed by doctorId. */
  equippedItemMap?: Map<string, DoctorEquipmentRow>
  onClose: () => void
}
