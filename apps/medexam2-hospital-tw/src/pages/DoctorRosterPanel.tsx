/**
 * 醫師名冊 panel — body of the doctor roster, extracted from the original
 * single-page `DoctorRoster` component. Rendered inside the `/roster`
...
export function DoctorRosterPanel() {
